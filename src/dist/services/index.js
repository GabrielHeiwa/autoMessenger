...
var WebWhatsappClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                ...
                interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(count === dataMessages.numbers.length)) return [3 /*break*/, 5];
                                _a.label = 1;
                            case 1:
                                _a.trys.push([1, 3, , 4]);
    ...
    ;
    WebWhatsappClient.prototype.destroyClient = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ClientWhatsapp.pupBrowser.close()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
